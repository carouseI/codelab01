...
using StarterAssets; //access FPController
        ...
        void Update()
        {
            if (timerIsRunning) //set countdown trigger
            {
                ...
                else
                {
                    ...
                    player.GetComponent<FirstPersonController>().enabled = false; //stops player movement at countdown
                    ...
                    //{
                    //    Enemies[i].GetComponent<EnemyLocomotionManager>().enabled = false; //stop enemy movement
                    //}
