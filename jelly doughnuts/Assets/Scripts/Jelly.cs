...
public class Jelly : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        #region //Cos
        float x = Mathf.Cos(Time.time *  _frequency) * _amplitude; //multiply to adjust height/length of cosine;  multiply by frequency to adjust how quick the movement is
